...
#define ENABLE_FIFO_WAKEUP           1    //Sensor will wake up automatically when FIFO is full
#define ENABLE_SNIFF_SHAKE_WAKEUP    0    //Sensor will wake up until external force over the threshold setting
